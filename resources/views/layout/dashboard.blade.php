...
<body x-data="{ page: '@yield('page')', 'loaded': true, 'darkMode': false, 'stickyMenu': false, 'sidebarToggle': false, 'scrollTop': false, @yield('x-data') }" x-init="darkMode = JSON.parse(localStorage.getItem('darkMode'));
$watch('darkMode', value => localStorage.setItem('darkMode', JSON.stringify(value)))"
    :class="{ 'dark bg-gray-900': darkMode === true } @yield('x-init')">
    <!-- ===== Preloader Start ===== -->
                        ...
                        <ul class="flex flex-col gap-4 mb-6">
                            ...
                            <li>
                                <a href="{{ route('dashboard') }}"
                                    ...
                                    :class="(selected === 'Dashboard') || (page === 'dashboardAlat' ||
                                        page === 'dashboardSensor') ?
                                    'menu-item-active' : 'menu-item-inactive'">
                                    <svg :class="(selected === 'Dashboard') || (page === 'dashboardAlat' ||
                                        page === 'dashboardSensor') ?
                                    ...
                                    <ul :class="sidebarToggle ? 'lg:hidden' : 'flex'"
                                        ...
                                        <li>
                                            <a href="{{ route('dashboard') }}" class="menu-dropdown-item group"
                                                :class="page === 'dashboardAlat' ? 'menu-dropdown-item-active' :
                                                    'menu-dropdown-item-inactive'">
                                                Alat
                                            </a>
                                        </li>
                                        <li>
                                            <a href="{{ route('dashboard.sensor') }}" class="menu-dropdown-item group"
                                                :class="page === 'dashboardSensor' ? 'menu-dropdown-item-active' :
                                                    'menu-dropdown-item-inactive'">
                                                Sensors
                                            </a>
                                        </li>
                            ...
                            <li>
                                <a href="#" @click.prevent="selected = (selected === 'Tools' ? '':'Tools')"
                                    class="menu-item group"
                                    :class="(selected === 'Tools') || (page === 'toolsSensor' || page === 'toolsAlat') ?
                                    'menu-item-active' :
                                    'menu-item-inactive'">
                                    <svg :class="(selected === 'Tools') || (page === 'toolsSensor' || page === 'toolsAlat') ?
                                    'menu-item-icon-active' : 'menu-item-icon-inactive'"
                                        width="24" height="24" viewBox="0 0 24 24" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path fill-rule="evenodd" clip-rule="evenodd"
                                    ...
                                    <svg class="menu-item-arrow absolute right-2.5 top-1/2 -translate-y-1/2 stroke-current"
                                        :class="[(selected === 'Tools') ? 'menu-item-arrow-active' :
                                            'menu-item-arrow-inactive', sidebarToggle ? 'lg:hidden' : ''
                                        ]"
                                        width="20" height="20" viewBox="0 0 20 20" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                ...
                                <!-- Dropdown Menu Start -->
                                <div class="overflow-hidden transform translate"
                                    :class="(selected === 'Tools') ? 'block' : 'hidden'">
                                    <ul :class="sidebarToggle ? 'lg:hidden' : 'flex'"
                                        class="flex flex-col gap-1 mt-2 menu-dropdown pl-9">
                                        <li>
                                            <a href="{{ route('dashboard.tools.sensor') }}"
                                                class="menu-dropdown-item group"
                                                :class="page === 'toolsSensor' ? 'menu-dropdown-item-active' :
                                                    'menu-dropdown-item-inactive'">
                                                Sensors
                                            </a>
                                        </li>
                                        <li>
                                            <a href="{{ route('dashboard.tools.alat') }}"
                                                class="menu-dropdown-item group"
                                                :class="page === 'toolsAlat' ? 'menu-dropdown-item-active' :
                                                    'menu-dropdown-item-inactive'">
                                                Alat
                                            </a>
                                        </li>
