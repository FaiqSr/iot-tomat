...
<body x-data="{ page: '@yield('page')', 'loaded': true, 'stickyMenu': false, 'sidebarToggle': false, 'scrollTop': false, @yield('x-data') }" :class="{ 'dark bg-gray-900 ': darkMode === true } @yield('x-init')">
    <!-- ===== Preloader Start ===== -->
